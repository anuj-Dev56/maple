...
const HistoryEditPanel = ({ history }) => {
  ...
  return (
    <div className="flex flex-col gap-3 p-4 bg-zinc-900/60 border border-zinc-700 rounded-lg">
      {/* Header */}
      ...
      <div className="flex flex-col gap-2">
        ...
        <button
          onClick={handleShare}
          className="flex items-center gap-3 px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 rounded-md transition-colors text-sm border border-zinc-700"
        >
          <svg
            className="w-4 h-4"
            fill="none"
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 rounded-md transition-colors text-xs border border-zinc-700"
          >
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 cursor-pointer bg-red-900/20 hover:bg-red-900/40 text-red-400 rounded-md transition-colors text-sm border border-red-900/50 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isDeleting ? (
            <>
              <svg
            ...
            <>
              ...
              {!player?.id ? "Select from sidebar History" : "Delete from History"}
            </>
          )}
        </button>
      </div>
